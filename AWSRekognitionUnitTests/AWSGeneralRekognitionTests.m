...
- (void)testAssociateFaces {
    NSString *key = @"testAssociateFaces";
    ...
    [[[[AWSRekognition RekognitionForKey:key] associateFaces:[AWSRekognitionAssociateFacesRequest new]] continueWithBlock:^id(AWSTask *task) {
...
- (void)testAssociateFacesCompletionHandler {
    NSString *key = @"testAssociateFaces";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] associateFaces:[AWSRekognitionAssociateFacesRequest new] completionHandler:^(AWSRekognitionAssociateFacesResponse* _Nullable response, NSError * _Nullable error) {
...
- (void)testCopyProjectVersion {
    NSString *key = @"testCopyProjectVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] replicateProjectVersion:[AWSRekognitionReplicateProjectVersionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testCopyProjectVersionCompletionHandler {
    NSString *key = @"testCopyProjectVersion";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] replicateProjectVersion:[AWSRekognitionReplicateProjectVersionRequest new] completionHandler:^(AWSRekognitionReplicateProjectVersionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testCreateDataset {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] createDataset:[AWSRekognitionCreateDatasetRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testCreateDatasetCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] createDataset:[AWSRekognitionCreateDatasetRequest new] completionHandler:^(AWSRekognitionCreateDatasetResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testCreateFaceLivenessSession {
    NSString *key = @"testCreateFaceLivenessSession";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] createFaceLivenessSession:[AWSRekognitionCreateFaceLivenessSessionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testCreateFaceLivenessSessionCompletionHandler {
    NSString *key = @"testCreateFaceLivenessSession";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] createFaceLivenessSession:[AWSRekognitionCreateFaceLivenessSessionRequest new] completionHandler:^(AWSRekognitionCreateFaceLivenessSessionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testCreateUser {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] createUser:[AWSRekognitionCreateUserRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testCreateUserCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] createUser:[AWSRekognitionCreateUserRequest new] completionHandler:^(AWSRekognitionCreateUserResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDeleteDataset {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] deleteDataset:[AWSRekognitionDeleteDatasetRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDeleteDatasetCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] deleteDataset:[AWSRekognitionDeleteDatasetRequest new] completionHandler:^(AWSRekognitionDeleteDatasetResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDeleteProjectPolicy {
    NSString *key = @"testDeleteProjectPolicy";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] deleteProjectPolicy:[AWSRekognitionDeleteProjectPolicyRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDeleteProjectPolicyCompletionHandler {
    NSString *key = @"testDeleteProjectPolicy";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] deleteProjectPolicy:[AWSRekognitionDeleteProjectPolicyRequest new] completionHandler:^(AWSRekognitionDeleteProjectPolicyResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDeleteUser {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] deleteUser:[AWSRekognitionDeleteUserRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDeleteUserCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] deleteUser:[AWSRekognitionDeleteUserRequest new] completionHandler:^(AWSRekognitionDeleteUserResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDescribeDataset {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] describeDataset:[AWSRekognitionDescribeDatasetRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDescribeDatasetCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] describeDataset:[AWSRekognitionDescribeDatasetRequest new] completionHandler:^(AWSRekognitionDescribeDatasetResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDetectProtectiveEquipment {
    NSString *key = @"testDetectProtectiveEquipment";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] detectProtectiveEquipment:[AWSRekognitionDetectProtectiveEquipmentRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDetectProtectiveEquipmentCompletionHandler {
    NSString *key = @"testDetectProtectiveEquipment";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] detectProtectiveEquipment:[AWSRekognitionDetectProtectiveEquipmentRequest new] completionHandler:^(AWSRekognitionDetectProtectiveEquipmentResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDisassociateFaces {
    NSString *key = @"testDisassociateFaces";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] disassociateFaces:[AWSRekognitionDisassociateFacesRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDisassociateFacesCompletionHandler {
    NSString *key = @"testDisassociateFaces";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] disassociateFaces:[AWSRekognitionDisassociateFacesRequest new] completionHandler:^(AWSRekognitionDisassociateFacesResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testDistributeDatasetEntries {
    NSString *key = @"testDistributeDatasetEntries";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] distributeDatasetEntries:[AWSRekognitionDistributeDatasetEntriesRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testDistributeDatasetEntriesCompletionHandler {
    NSString *key = @"testDistributeDatasetEntries";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] distributeDatasetEntries:[AWSRekognitionDistributeDatasetEntriesRequest new] completionHandler:^(AWSRekognitionDistributeDatasetEntriesResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testGetFaceLivenessSessionResults {
    NSString *key = @"testGetFaceLivenessSessionResults";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] getFaceLivenessSessionResults:[AWSRekognitionGetFaceLivenessSessionResultsRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testGetFaceLivenessSessionResultsCompletionHandler {
    NSString *key = @"testGetFaceLivenessSessionResults";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] getFaceLivenessSessionResults:[AWSRekognitionGetFaceLivenessSessionResultsRequest new] completionHandler:^(AWSRekognitionGetFaceLivenessSessionResultsResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testGetSegmentDetection {
    NSString *key = @"testGetSegmentDetection";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] getSegmentDetection:[AWSRekognitionGetSegmentDetectionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testGetSegmentDetectionCompletionHandler {
    NSString *key = @"testGetSegmentDetection";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] getSegmentDetection:[AWSRekognitionGetSegmentDetectionRequest new] completionHandler:^(AWSRekognitionGetSegmentDetectionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testListDatasetEntries {
    NSString *key = @"testListDatasetEntries";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] listDatasetEntries:[AWSRekognitionListDatasetEntriesRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListDatasetEntriesCompletionHandler {
    NSString *key = @"testListDatasetEntries";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] listDatasetEntries:[AWSRekognitionListDatasetEntriesRequest new] completionHandler:^(AWSRekognitionListDatasetEntriesResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testListDatasetLabels {
    NSString *key = @"testListDatasetLabels";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] listDatasetLabels:[AWSRekognitionListDatasetLabelsRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListDatasetLabelsCompletionHandler {
    NSString *key = @"testListDatasetLabels";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] listDatasetLabels:[AWSRekognitionListDatasetLabelsRequest new] completionHandler:^(AWSRekognitionListDatasetLabelsResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testListProjectPolicies {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] listProjectPolicies:[AWSRekognitionListProjectPoliciesRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListProjectPoliciesCompletionHandler {
    NSString *key = @"testListProjectPolicies";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] listProjectPolicies:[AWSRekognitionListProjectPoliciesRequest new] completionHandler:^(AWSRekognitionListProjectPoliciesResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testListTagsForResource {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] listTagsForResource:[AWSRekognitionListTagsForResourceRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListTagsForResourceCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] listTagsForResource:[AWSRekognitionListTagsForResourceRequest new] completionHandler:^(AWSRekognitionListTagsForResourceResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testListUsers {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] listUsers:[AWSRekognitionListUsersRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testListUsersCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] listUsers:[AWSRekognitionListUsersRequest new] completionHandler:^(AWSRekognitionListUsersResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testPutProjectPolicy {
    NSString *key = @"testPutProjectPolicy";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] putProjectPolicy:[AWSRekognitionPutProjectPolicyRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testPutProjectPolicyCompletionHandler {
    NSString *key = @"testPutProjectPolicy";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] putProjectPolicy:[AWSRekognitionPutProjectPolicyRequest new] completionHandler:^(AWSRekognitionPutProjectPolicyResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testSearchUsers {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] searchUsers:[AWSRekognitionSearchUsersRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testSearchUsersCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] searchUsers:[AWSRekognitionSearchUsersRequest new] completionHandler:^(AWSRekognitionSearchUsersResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testSearchUsersByImage {
    NSString *key = @"testSearchUsersByImage";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] searchUsersByImage:[AWSRekognitionSearchUsersByImageRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testSearchUsersByImageCompletionHandler {
    NSString *key = @"testSearchUsersByImage";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] searchUsersByImage:[AWSRekognitionSearchUsersByImageRequest new] completionHandler:^(AWSRekognitionSearchUsersByImageResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testStartSegmentDetection {
    NSString *key = @"testStartSegmentDetection";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] startSegmentDetection:[AWSRekognitionStartSegmentDetectionRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testStartSegmentDetectionCompletionHandler {
    NSString *key = @"testStartSegmentDetection";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] startSegmentDetection:[AWSRekognitionStartSegmentDetectionRequest new] completionHandler:^(AWSRekognitionStartSegmentDetectionResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testTagResource {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] tagResource:[AWSRekognitionTagResourceRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testTagResourceCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] tagResource:[AWSRekognitionTagResourceRequest new] completionHandler:^(AWSRekognitionTagResourceResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testUntagResource {
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] untagResource:[AWSRekognitionUntagResourceRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testUntagResourceCompletionHandler {
	...
	[[AWSRekognition RekognitionForKey:key] untagResource:[AWSRekognitionUntagResourceRequest new] completionHandler:^(AWSRekognitionUntagResourceResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testUpdateDatasetEntries {
    NSString *key = @"testUpdateDatasetEntries";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] updateDatasetEntries:[AWSRekognitionUpdateDatasetEntriesRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testUpdateDatasetEntriesCompletionHandler {
    NSString *key = @"testUpdateDatasetEntries";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] updateDatasetEntries:[AWSRekognitionUpdateDatasetEntriesRequest new] completionHandler:^(AWSRekognitionUpdateDatasetEntriesResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
...
- (void)testUpdateStreamProcessor {
    NSString *key = @"testUpdateStreamProcessor";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
    ...
    XCTAssertNotNil(mockNetworking);
    [awsClient setValue:mockNetworking forKey:@"networking"];
    [[[[AWSRekognition RekognitionForKey:key] updateStreamProcessor:[AWSRekognitionUpdateStreamProcessorRequest new]] continueWithBlock:^id(AWSTask *task) {
        XCTAssertNotNil(task.error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", task.error.domain);
        XCTAssertEqual(8848, task.error.code);
        XCTAssertNil(task.result);
...
- (void)testUpdateStreamProcessorCompletionHandler {
    NSString *key = @"testUpdateStreamProcessor";
    AWSServiceConfiguration *configuration = [[AWSServiceConfiguration alloc] initWithRegion:AWSRegionUSEast1 credentialsProvider:nil];
    [AWSRekognition registerRekognitionWithConfiguration:configuration forKey:key];
	...
	[[AWSRekognition RekognitionForKey:key] updateStreamProcessor:[AWSRekognitionUpdateStreamProcessorRequest new] completionHandler:^(AWSRekognitionUpdateStreamProcessorResponse* _Nullable response, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        XCTAssertEqualObjects(@"OCMockExpectedNetworkingError", error.domain);
        XCTAssertEqual(8848, error.code);
        XCTAssertNil(response);
